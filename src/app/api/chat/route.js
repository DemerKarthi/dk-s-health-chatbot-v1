...
export async function POST(request) {
  try {
    ...
    const systemPrompt = 
      "You are a helpful AI wellness assistant named DK's Chatbot. Your goal is to provide supportive, " +
    ...
    assistantResponse = assistantResponse.split("DK's Chatbot:")[1]?.trim() || assistantResponse;
