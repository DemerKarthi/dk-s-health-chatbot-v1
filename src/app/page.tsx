...
import { ChatComponent } from "./../components/components";
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-b from-blue-100 to-green-200 flex flex-col items-center justify-center z-50">
      <div className="bg-white p-8 rounded-xl shadow-lg flex flex-col items-center">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">DK's chatbot</h2>
      ...
      <div className="flex h-screen">
        ...
        <div className="hidden md:flex flex-col fixed left-0 top-0 bottom-0 w-64 bg-white border-r border-gray-200 p-4 space-y-2 shadow-lg z-10">
          <div className="mb-6 px-4">
            <CardTitle className="text-xl font-bold text-gray-800 mb-1">DK's chatbot</CardTitle>
        ...
        <div className="hidden md:flex flex-col fixed left-64 top-0 bottom-0 w-64 bg-blue-50 border-r border-gray-200 p-4 overflow-y-auto">
          <h2 className="font-medium text-gray-800 mb-4">Featured Topics</h2>
          ...
          <div className="h-full md:hidden">
            <div className="h-full bg-white">
              <CardHeader className="border-b bg-gray-100 py-3">
                <CardTitle className="text-center text-lg font-semibold text-gray-800">DK's chatbot</CardTitle>
